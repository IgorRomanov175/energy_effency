...
with open("C:\Project\project1.test-master\json\init_main_data_1.json", "r") as json_file:
...
def heat_transfer_resistance_of_external_walls():
    ...
    first_calc_coeff = [calc_values1, calc_area_1]
    ...
    second_calc_coeff = [calc_values2, calc_area_1_1]
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_10"]["active"] == 1:
        ...
        transfer_node_10 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_10)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_11"]["active"] == 1:
        ...
        transfer_node_11 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_11)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_12"]["active"] == 1:
        ...
        transfer_node_12 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_12)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_13"]["active"] == 1:
        ...
        transfer_node_13 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_13)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_14"]["active"] == 1:
        ...
        transfer_node_14 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_14)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_15"]["active"] == 1:
        ...
        transfer_node_15 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_15)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_16"]["active"] == 1:
        ...
        transfer_node_16 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_16)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_17"]["active"] == 1:
        ...
        transfer_node_17 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_17)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_18"]["active"] == 1:
        ...
        transfer_node_18 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_18)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_19"]["active"] == 1:
        ...
        transfer_node_19 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_19)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_20"]["active"] == 1:
        ...
        transfer_node_20 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_20)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_21"]["active"] == 1:
        ...
        transfer_node_21 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_21)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_22"]["active"] == 1:
        ...
        transfer_node_22 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_22)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_23"]["active"] == 1:
        ...
        transfer_node_23 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_23)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_24"]["active"] == 1:
        ...
        transfer_node_24 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_24)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_25"]["active"] == 1:
        ...
        transfer_node_25 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_25)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_26"]["active"] == 1:
        ...
        transfer_node_26 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_26)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_27"]["active"] == 1:
        ...
        transfer_node_27 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_27)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_28"]["active"] == 1:
        ...
        transfer_node_28 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_28)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_29"]["active"] == 1:
        ...
        transfer_node_29 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_29)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_30"]["active"] == 1:
        ...
        transfer_node_30 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_30)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_31"]["active"] == 1:
        ...
        transfer_node_31 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_31)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_32"]["active"] == 1:
        ...
        transfer_node_32 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_32)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_33"]["active"] == 1:
        ...
        transfer_node_33 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_33)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_34"]["active"] == 1:
        ...
        transfer_node_34 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_34)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_35"]["active"] == 1:
        ...
        transfer_node_35 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_35)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_36"]["active"] == 1:
        ...
        transfer_node_36 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_36)
    ...
    if a_json["paragraph 3.1.4"]["linear_coeff_values_37"]["active"] == 1:
        ...
        transfer_node_37 = [linear_coeff, linear_lenth]
        heat_transfer_coeff_2.append(transfer_node_37)
    ...
    if a_json["paragraph 3.1.4"]["point_coeff_values_1"]["active"] == 1:
        ...
        transfer_node_1_1 = [point_coeff, point_num]
        heat_transfer_coeff_2.append(transfer_node_1_1)
    ...
    if a_json["paragraph 3.1.4"]["point_coeff_values_2"]["active"] == 1:
        ...
        transfer_node_1_2 = [point_coeff, point_num]
        heat_transfer_coeff_2.append(transfer_node_1_2)
    ...
    if a_json["paragraph 3.1.4"]["point_coeff_values_3"]["active"] == 1:
        ...
        transfer_node_1_3 = [point_coeff, point_num]
        heat_transfer_coeff_2.append(transfer_node_1_3)
    ...
    if a_json["paragraph 3.1.4"]["point_coeff_values_4"]["active"] == 1:
        ...
        transfer_node_1_4 = [point_coeff, point_num]
        heat_transfer_coeff_2.append(transfer_node_1_4)

    m4 = ThermLogic3(area)
    ans = m4.therm_calc1(heat_transfer_coeff_1, heat_transfer_coeff_2)
    print("\nПовна відповідь", ans)
